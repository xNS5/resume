  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
     ...
     \resumeItemListStart
        ...
        \resumeItem{Worked with banking analysts to idenfity and resolve bugs in application functionality.}
        \resumeItem{Developed, tested, and released quality of life enhancements to existing ReactJS components utilized in company banking applications.}
     \resumeItemListEnd 
