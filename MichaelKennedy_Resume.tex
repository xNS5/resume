  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
     ...
     \resumeItemListStart
        ...
        \resumeItem{Designed, developed, and tested an interactive application that displays a visual diff of code changes in . This tool streamlines the code review process, enabling team members to quickly identify and review changes made while working on a ticket.}
     \resumeItemListEnd
