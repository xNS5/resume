...
\section{TECHNICAL SKILLS}
 \begin{itemize}[leftmargin=0in, label={}]
    \small{\item{
    \textbf{General Experience} {: Data Structures, Algorithms, Databases, Git, Azure, Jenkins, JIRA, Kanban.}\\
     \textbf{Languages} {: Java, Javascript, Dart, C, Python, Bash, PowerShell.} \\
