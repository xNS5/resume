...
%------------------SUMMARY-----------------------
\section{SUMMARY}
Tenacious, detail-oriented software engineer with a knack for developing innovative solutions, and a passion for solving problems. During my tenure at Heritage Bank NW, I developed user-friendly, accessible solutions that bridged critical gaps in our software development lifecycle and business workflows. Highlights include developing an interactive code review utility, a scalable system for efficient PDF tracking and management, and a A VNC server solution that seamlessly replicates an in-person pair programming experience for remote developers by providing real-time, collaborative coding sessions with synchronized views and interactive control sharing.
...
\resumeSubHeadingListStart
    ...
    \resumeProjectHeading{\textbf{Accessibility Testing Automation Application} -- Sails.js, Vue.js, Selenium, Python, Deque aXe API}{July 2021 -- January 2022}
    \resumeItemListStart
    ...
    \resumeProjectHeading
      {\textbf{Web Content Accessibility Guideline (WCAG) Reference CJS} -- Javascript}{July 2021 - January 2022}
        \resumeItemListStart
