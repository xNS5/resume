  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
     ...
     \resumeItemListStart
        ...
        \resumeItem{Spearheaded an 80\% reduction in integration time for new Treasury Management services within the Treasury Management application by eliminating hard-coded values and introducing a database-dependent solution.}
        ...
        \resumeItem{Researched and tested VNC server solutions on an Ubuntu virtual machine and Windows OS to facilitate Mob Programming sessions between remote team members.}
     \resumeItemListEnd
